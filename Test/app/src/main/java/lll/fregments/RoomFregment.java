...
import lll.service.CreatRoomsResult;
import lll.test.R;
import lll.test.room_showtimeActivity;

public class RoomFregment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Callable callable = new CreatRoomsResult(authority);
        Future future = pool.submit(callable);
        List<Rooms> result=new ArrayList<Rooms>();
        try {
            result = (List<Rooms>) future.get();
            ...
            public View generateView(final int position, ViewGroup parent) {
                ...
                v.findViewById(R.id.magnifier).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(mContext, room_showtimeActivity.class);
                        //采用Intent普通传值的方式
