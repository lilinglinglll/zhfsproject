...
//        registerView = findViewById(shem.com.materiallogin.R.id.register_window);
//        registerCard = findViewById(shem.com.materiallogin.R.id.register_card);
//        registerTitle = (TextView) findViewById(shem.com.materiallogin.R.id.register_title);
//        registerUser = (TextInputLayout) findViewById(shem.com.materiallogin.R.id.register_user);
//        registerPass = (TextInputLayout) findViewById(shem.com.materiallogin.R.id.register_pass);
//        registerPassRep = (TextInputLayout) findViewById(shem.com.materiallogin.R.id.register_pass_rep);
//        registerBtn = (TextView) findViewById(shem.com.materiallogin.R.id.register_btn);
//
//        registerFab = (FloatingActionButton) findViewById(shem.com.materiallogin.R.id.register_fab);
//        registerCancel = findViewById(shem.com.materiallogin.R.id.register_cancel);
//
//
...
//        });
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.MaterialLoginView, 0, 0);
...
//            string = a.getString(shem.com.materiallogin.R.styleable.MaterialLoginView_registerTitle);
//            if (string != null) {
//                registerTitle.setText(string);
//            }

//            string = a.getString(shem.com.materiallogin.R.styleable.MaterialLoginView_registerHint);
//            if (string != null) {
//                registerUser.setHint(string);
//            }

//            string = a.getString(shem.com.materiallogin.R.styleable.MaterialLoginView_registerPasswordHint);
//            if (string != null) {
//                registerPass.setHint(string);
//            }

//            string = a.getString(shem.com.materiallogin.R.styleable.MaterialLoginView_registerRepeatPasswordHint);
//            if (string != null) {
//                registerPassRep.setHint(string);
//            }

//            string = a.getString(shem.com.materiallogin.R.styleable.MaterialLoginView_registerActionText);
//            if (string != null) {
//                registerBtn.setText(string);
//            }

            int color = a.getColor(R.styleable.MaterialLoginView_loginTextColor, ContextCompat.getColor(getContext(), shem.com.materiallogin.R.color.material_login_login_text_color));
            loginUser.getEditText().setTextColor(color);
            loginPass.getEditText().setTextColor(color);

//            color = a.getColor(shem.com.materiallogin.R.styleable.MaterialLoginView_registerTextColor, ContextCompat.getColor(getContext(), shem.com.materiallogin.R.color.material_login_register_text_color));
...
//                    a.getResourceId(shem.com.materiallogin.R.styleable.MaterialLoginView_registerIcon, shem.com.materiallogin.R.drawable.ic_add_white_24dp));
        } finally {
            a.recycle();
        }
    }
